...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    "AboutLoc_description" : MessageLookupByLibrary.simpleMessage("Minitel Toolbox includes the most useful tools to have a trouble-free WiFi."),
    "AboutLoc_developper" : MessageLookupByLibrary.simpleMessage("Developer"),
    "AboutLoc_lastVestion" : MessageLookupByLibrary.simpleMessage("Lastest version"),
    "AboutLoc_license" : MessageLookupByLibrary.simpleMessage("License"),
    "AboutLoc_privacyPolicySubtitle" : MessageLookupByLibrary.simpleMessage("No data is shared and stored without your knowledge. The data collected is the data you provide us (diagnostic) and is never saved."),
    "AboutLoc_privacyPolicyTitle" : MessageLookupByLibrary.simpleMessage("Privacy Policy"),
    "AboutLoc_title" : MessageLookupByLibrary.simpleMessage("About Minitel Toolbox"),
    "AboutLoc_website" : MessageLookupByLibrary.simpleMessage("Website"),
    "AgendaLoc_emptyAgenda0" : MessageLookupByLibrary.simpleMessage("Well ? No class ?"),
    "AgendaLoc_emptyAgenda1" : MessageLookupByLibrary.simpleMessage("\'smells like a barbecue..."),
    "AgendaLoc_emptyAgenda2" : MessageLookupByLibrary.simpleMessage("Freeedom !"),
    "AgendaLoc_emptyAgenda3" : MessageLookupByLibrary.simpleMessage("Lucky m8 !"),
    "AgendaLoc_emptyAgenda4" : MessageLookupByLibrary.simpleMessage("Spend more time with the family!\n(instead of watching the next classes)"),
    "AgendaLoc_emptyAgenda5" : MessageLookupByLibrary.simpleMessage("The application has more than 10,000 lines of code....\n\n(with 40,000 additions and 30,000 deletions)"),
    "AgendaLoc_emptyAgenda6" : MessageLookupByLibrary.simpleMessage("The application is developed with Flutter and ❤️"),
    "AgendaLoc_emptyAgenda7" : MessageLookupByLibrary.simpleMessage("Minitel is king!"),
    ...
    "DiagnoseLoc_pingLoContent1" : MessageLookupByLibrary.simpleMessage("Checks if the TCP/IP software is working.\n"),
    ...
    "DualbootLoc_prepHeader" : MessageLookupByLibrary.simpleMessage("Preparations :\n"),
    "DualbootLoc_risksContent" : MessageLookupByLibrary.simpleMessage("    •  Linux is more stable, but distribution updates are more fragile (80% of Ubuntu users prefer to reinstall rather than update)\n    •  Drivers are the first causes of sudden crashes (NVIDIA, Realtek...)\n    •  A wrong BIOS configuration can also be fatal for you\n\n"),
    "DualbootLoc_risksHeader" : MessageLookupByLibrary.simpleMessage("Be aware of the risks of installing Linux:\n"),
    "ImprimanteLoc_header" : MessageLookupByLibrary.simpleMessage("Configuring the printer"),
    "ImprimanteLoc_linuxContent1" : MessageLookupByLibrary.simpleMessage("    -  Add smb://192.168.130.2/imprimantes-gcp  to network printers\n    -  Driver: https://www.openprinting.org/download/PPD/Ricoh/PS/Ricoh-MP_C3004_PS.ppd"),
    "ImprimanteLoc_linuxContent2" : MessageLookupByLibrary.simpleMessage("    -  Go to http://localhost:631/admin (linux account name and password)\n    -  The tab \"Administration\"\n    -  \"Add Printer\"\n    -  Type SMB, address smb://192.168.130.2/imprimantes-gcp\n    -  Use the PPD file : https://www.openprinting.org/download/PPD/Ricoh/PS/Ricoh-MP_C3004_PS.ppd\n    -  Configure the rest and it should be okay"),
    "ImprimanteLoc_pukContent" : MessageLookupByLibrary.simpleMessage("Use the Minitel application > Apps > Printer"),
    "ImprimanteLoc_windowsContent" : MessageLookupByLibrary.simpleMessage("    -  Open \\\\192.168.168.130.2 with Windows Explorer\n    -  Enter first name and password (also test EMSE2000\\first name.name)\n    -  Double-click on \"imprimantes-gpc\""),
    "LoginLoc_domainNameContent1" : MessageLookupByLibrary.simpleMessage("Choose between fw-cgcp.emse.fr, 10.163.0.2 and 195.83.139.7\n"),
    "LoginLoc_domainNameContent2" : MessageLookupByLibrary.simpleMessage("If the local network supports a DNS, such as 192.168.130.33 (DSI) or 10.163.0.6 (Minitel), you can try fw-cgcp.emse.fr.\nIf the network is Minitel (WiFi Minitel), use 10.163.0.2\n"),
    "LoginLoc_domainNameContent3" : MessageLookupByLibrary.simpleMessage("Generally, 195.83.139.7 is suitable in 90% of cases.\nThis is the public IP address of the portal, and is authorized by the gateway.\n"),
    "LoginLoc_header" : MessageLookupByLibrary.simpleMessage("Authentication"),
    "MailLoc_header" : MessageLookupByLibrary.simpleMessage("Importing Sogo emails"),
    "MailLoc_mailContent1" : MessageLookupByLibrary.simpleMessage("With your favorite email application, use the manual configuration and fill in the corresponding fields."),
    "MailLoc_mailContent2" : MessageLookupByLibrary.simpleMessage("Email: firstname.lastname@etu.emse.fr\nPassword: your school password\n\nIncoming server: IMAP\nHost name: messel.emse.fr\nPort: 993\nSecurity: ssl/tls\nAuthentication method: standard password\nIdentifier: firstname.lastname (⚠️ without @etu.emse.fr)\n\nOutgoing server:\nHost name: messel.emse.fr\nPort: 465\nSecurity: ssl/tls\nuthentication method: standard password\nIdentifier: firstname.lastname (⚠️ without @etu.emse.fr)"),
    "NewsLoc_seeFacebook" : MessageLookupByLibrary.simpleMessage("See on Facebook ..."),
    ...
    "PortalLoc_title" : MessageLookupByLibrary.simpleMessage("Portal"),
    "PortalLoc_usernameHint" : MessageLookupByLibrary.simpleMessage("firstname.lastname"),
    "PortalLoc_usernameLabel" : MessageLookupByLibrary.simpleMessage("Username"),
    "ReportingLoc_chamberHint" : MessageLookupByLibrary.simpleMessage("Room number"),
    "ReportingLoc_chamberLabel" : MessageLookupByLibrary.simpleMessage("Room"),
    "ReportingLoc_forceName" : MessageLookupByLibrary.simpleMessage("Last name AND First name"),
    "ReportingLoc_idHint" : MessageLookupByLibrary.simpleMessage("Last name First name"),
    "ReportingLoc_idLabel" : MessageLookupByLibrary.simpleMessage("Identity"),
    "ReportingLoc_notEmpty" : MessageLookupByLibrary.simpleMessage("Must not be empty"),
    "ReportingLoc_share" : MessageLookupByLibrary.simpleMessage("Share"),
    "ReportingLoc_slack" : MessageLookupByLibrary.simpleMessage("Notify on Slack"),
    "ReportingLoc_title" : MessageLookupByLibrary.simpleMessage("Report to Minitel"),
    "ReportingLoc_titleHint" : MessageLookupByLibrary.simpleMessage("I don\'t have internet anymore!"),
    "ReportingLoc_titleLabel" : MessageLookupByLibrary.simpleMessage("Title"),
    "TutorialLoc_content1" : MessageLookupByLibrary.simpleMessage("1. Log in to \'WiFi Minitel\'."),
    "TutorialLoc_content2" : MessageLookupByLibrary.simpleMessage("2. Start the diagnostic sequence by pressing the button, and wait 1 minute."),
    "TutorialLoc_content3" : MessageLookupByLibrary.simpleMessage("3. Fill out your report. Do not forget a means of communication (room, mail, messenger...)"),
    "TutorialLoc_content4" : MessageLookupByLibrary.simpleMessage("4. Connect to a network where there is Internet."),
    "TutorialLoc_content5" : MessageLookupByLibrary.simpleMessage("5. Send the report."),
    "TutorialLoc_example" : MessageLookupByLibrary.simpleMessage("Example : \nTitle: Not Internet since Monday. \nDescription: I frequently lose the connection when I\'m on Ethernet. Wifi is okay."),
    "TutorialLoc_header" : MessageLookupByLibrary.simpleMessage("How to report without the Internet?"),
    "TutorialLoc_notice" : MessageLookupByLibrary.simpleMessage("NOTE: It is recommended to install the Root and Busybox."),
    "VMLoc_customizeContent" : MessageLookupByLibrary.simpleMessage("    -  Useful for having a sandbox and doing lots of tests.\n    -  Useful for training on Linux (WM, DM, drivers, installations...), without blowing up your dual boot.\n    -  Useful for making a VPS.\n    -  Useful for using a compiler with a dedicated and protected environment.\n\n"),
    "VMLoc_customizeHeader" : MessageLookupByLibrary.simpleMessage("A VM is therefore made to be tampered to death:\n"),
    "VMLoc_definitionContent" : MessageLookupByLibrary.simpleMessage("    A Machine whose components are emulated.\n    A Machine that is strictly isolated from the host.\n    As the components are emulated, the chances of a VM crash are much lower.\n\n"),
    "VMLoc_definitionHeader" : MessageLookupByLibrary.simpleMessage("A VM is:\n"),
    "VMLoc_envContent" : MessageLookupByLibrary.simpleMessage("    -  For Linux: Docker, (Container Linux, i. e. dedicated environment per application) (Note that it also works on Windows because it runs a Linux VM on Hyper-V in the background.)\n    -  For Windows: Windows Subsystem for Linux 1 (Kernel Linux native, be careful, the hardware is not emulated!)\n    -  For Windows: Windows Subsystem for Linux 2 (+ Docker) (Kernel Linux in a micro-VM. Extremely fast and dynamically allocated RAM.)\n"),
    "VMLoc_envHeader" : MessageLookupByLibrary.simpleMessage("If it is a question of having a simple development environment:\n"),
    "VMLoc_hypervisorContent" : MessageLookupByLibrary.simpleMessage("    1.  [Leader] Hyper-V (type 1, Windows, if possible)\n    2.  [Visionary] KVM (type 1, Linux, 👍 Android)\n    3.  [Leader] VMWare Workstation (type 2, 👍 for networks, GNS3 and everything else)\n    4.  [Niche Player] VirtualBox (type 2)\n    5.  [Leader] VMware ESXi (type 1, for professionals)\n\n"),
    "VMLoc_hypervisorHeader" : MessageLookupByLibrary.simpleMessage("Here is the order of preference of a Hypervisor:\n"),
    "VMLoc_installContent" : MessageLookupByLibrary.simpleMessage("    -  Creating a virtual disk > 20 GB\n    -  Inserting a Linux image into the emulated CD port\n    -  Linux installation (similar to a dual boot)\n    -  Configuring SSH/telnet/RDP access\n"),
    "VMLoc_installHeader" : MessageLookupByLibrary.simpleMessage("It goes without saying that it is useless for a VM to have a graphical interface.\nVery often, an SSH connection is set up instead of using the graphical user interface or TTY.\n\nGenerally, the installation of a VM is quick and easy:\n"),
    "VMLoc_vmTypeContent" : MessageLookupByLibrary.simpleMessage("    -  Type I : Bare Metal, the OS is itself the hypervisor.\n    -  Type II : Hosted, the hypervisor is hosted by the host OS.\n\n"),
    "VMLoc_vmTypeHeader" : MessageLookupByLibrary.simpleMessage("Some hypervisors (VirtualBox, VMWare, Hyper-V) are even equipped with quick installation functions.\n\nThis also allows you to practice dual boot 😄.\n\nTypes of VMs:\n"),
