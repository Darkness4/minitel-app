...
class _$ZabbixHostsEventTearOff {
  const _$ZabbixHostsEventTearOff();

  GetZabbixHostsEvent get(int groupids) {
    return GetZabbixHostsEvent(
      groupids,
    );
  }
}
...
const $ZabbixHostsEvent = _$ZabbixHostsEventTearOff();
...
abstract class $ZabbixHostsEventCopyWith<$Res> {
  factory $ZabbixHostsEventCopyWith(
          ZabbixHostsEvent value, $Res Function(ZabbixHostsEvent) then) =
      _$ZabbixHostsEventCopyWithImpl<$Res>;
  $Res call({int groupids});
}

class _$ZabbixHostsEventCopyWithImpl<$Res>
    implements $ZabbixHostsEventCopyWith<$Res> {
  _$ZabbixHostsEventCopyWithImpl(this._value, this._then);

  final ZabbixHostsEvent _value;
  // ignore: unused_field
  final $Res Function(ZabbixHostsEvent) _then;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      groupids: groupids == freezed ? _value.groupids : groupids as int,
    ));
  }
}

abstract class $GetZabbixHostsEventCopyWith<$Res>
    implements $ZabbixHostsEventCopyWith<$Res> {
  factory $GetZabbixHostsEventCopyWith(
          GetZabbixHostsEvent value, $Res Function(GetZabbixHostsEvent) then) =
      _$GetZabbixHostsEventCopyWithImpl<$Res>;
  @override
  $Res call({int groupids});
}

class _$GetZabbixHostsEventCopyWithImpl<$Res>
    extends _$ZabbixHostsEventCopyWithImpl<$Res>
    implements $GetZabbixHostsEventCopyWith<$Res> {
  _$GetZabbixHostsEventCopyWithImpl(
      GetZabbixHostsEvent _value, $Res Function(GetZabbixHostsEvent) _then)
      : super(_value, (v) => _then(v as GetZabbixHostsEvent));

  @override
  GetZabbixHostsEvent get _value => super._value as GetZabbixHostsEvent;

  @override
  $Res call({
    Object groupids = freezed,
  }) {
    return _then(GetZabbixHostsEvent(
      groupids == freezed ? _value.groupids : groupids as int,
    ));
  }
}

class _$GetZabbixHostsEvent
    with DiagnosticableTreeMixin
    implements GetZabbixHostsEvent {
  const _$GetZabbixHostsEvent(this.groupids) : assert(groupids != null);
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ZabbixHostsEvent.get(groupids: $groupids)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'ZabbixHostsEvent.get'))
  ...
  @override
  int get hashCode =>
      runtimeType.hashCode ^ const DeepCollectionEquality().hash(groupids);
...
abstract class GetZabbixHostsEvent implements ZabbixHostsEvent {
  const factory GetZabbixHostsEvent(int groupids) = _$GetZabbixHostsEvent;
