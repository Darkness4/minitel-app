...
class _$_GithubUser implements _GithubUser {
    ...
    return identical(this, other) ||
        (other is _GithubUser &&
            ...
            (identical(other.gravatar_id, gravatar_id) ||
                const DeepCollectionEquality()
                    .equals(other.gravatar_id, gravatar_id)) &&
            ...
            (identical(other.following_url, following_url) ||
                const DeepCollectionEquality()
                    .equals(other.following_url, following_url)) &&
            (identical(other.gists_url, gists_url) ||
                const DeepCollectionEquality()
                    .equals(other.gists_url, gists_url)) &&
            (identical(other.starred_url, starred_url) ||
                const DeepCollectionEquality()
                    .equals(other.starred_url, starred_url)) &&
            (identical(other.subscriptions_url, subscriptions_url) ||
                const DeepCollectionEquality()
                    .equals(other.subscriptions_url, subscriptions_url)) &&
            ...
            (identical(other.repos_url, repos_url) ||
                const DeepCollectionEquality()
                    .equals(other.repos_url, repos_url)) &&
            (identical(other.events_url, events_url) ||
                const DeepCollectionEquality()
                    .equals(other.events_url, events_url)) &&
            (identical(other.received_events_url, received_events_url) ||
                const DeepCollectionEquality()
                    .equals(other.received_events_url, received_events_url)) &&
            (identical(other.type, type) ||
                const DeepCollectionEquality().equals(other.type, type)) &&
            (identical(other.site_admin, site_admin) ||
                const DeepCollectionEquality()
                    .equals(other.site_admin, site_admin)) &&
            ...
            (identical(other.hireable, hireable) ||
                const DeepCollectionEquality()
                    .equals(other.hireable, hireable)) &&
            (identical(other.bio, bio) ||
                const DeepCollectionEquality().equals(other.bio, bio)) &&
            (identical(other.public_repos, public_repos) ||
                const DeepCollectionEquality().equals(other.public_repos, public_repos)) &&
            (identical(other.public_gists, public_gists) || const DeepCollectionEquality().equals(other.public_gists, public_gists)) &&
            ...
            (identical(other.created_at, created_at) || const DeepCollectionEquality().equals(other.created_at, created_at)) &&
            (identical(other.updated_at, updated_at) || const DeepCollectionEquality().equals(other.updated_at, updated_at)));
  }
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(gravatar_id) ^
      const DeepCollectionEquality().hash(url) ^
      const DeepCollectionEquality().hash(html_url) ^
      const DeepCollectionEquality().hash(followers_url) ^
      const DeepCollectionEquality().hash(following_url) ^
      const DeepCollectionEquality().hash(gists_url) ^
      const DeepCollectionEquality().hash(starred_url) ^
      const DeepCollectionEquality().hash(subscriptions_url) ^
      ...
      const DeepCollectionEquality().hash(received_events_url) ^
      const DeepCollectionEquality().hash(type) ^
      const DeepCollectionEquality().hash(site_admin) ^
      const DeepCollectionEquality().hash(name) ^
      const DeepCollectionEquality().hash(company) ^
      const DeepCollectionEquality().hash(blog) ^
      const DeepCollectionEquality().hash(location) ^
      const DeepCollectionEquality().hash(email) ^
      const DeepCollectionEquality().hash(hireable) ^
      const DeepCollectionEquality().hash(bio) ^
      const DeepCollectionEquality().hash(public_repos) ^
      const DeepCollectionEquality().hash(public_gists) ^
