...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) =>
      <String, Function>{
        "sentenceDocDiagnoseHTTP1": MessageLookupByLibrary.simpleMessage(
        ...
        "sentenceDocDiagnoseHTTP2": MessageLookupByLibrary.simpleMessage(
            "    Si une erreur 4xx apparait, veuillez le signaler aux developeurs."),
        "sentenceDocDiagnoseHTTP3": MessageLookupByLibrary.simpleMessage(
            "    Si vous avez une erreur OS, la passerelle a un problème, et vous drvriez le signaler à la DSI."),
        "sentenceDocDiagnoseHTTP4": MessageLookupByLibrary.simpleMessage(
            "    Si vous avez une erreur HTTP 4xx, l\'outil de diagnostique a un problème, et vous drvriez le signaler aux developeurs."),
        "sentenceDocDiagnoseHTTP5": MessageLookupByLibrary.simpleMessage(
            "    Si vous avez une erreur HTTP 5xx, la passerelle a un problème, et vous drvriez le signaler à la DSI."),
        "sentenceDocDiagnoseHTTP6": MessageLookupByLibrary.simpleMessage(
        ...
        "sentenceDocDiagnoseNSLookup1": MessageLookupByLibrary.simpleMessage(
            "    S\'il n\'y a aucune réponse, mais le ping DNS fonctionne, votre appareil a un problème de cache DNS."),
        "sentenceDocDiagnoseNSLookup2": MessageLookupByLibrary.simpleMessage(
            "    Voici les meilleures solutions:"),
        "sentenceDocDiagnoseNSLookup3": MessageLookupByLibrary.simpleMessage(
            "    Pour les appareils portable, redémarrez le Wifi."),
        "sentenceDocDiagnosePerm": MessageLookupByLibrary.simpleMessage(
            "    Indique si vous avez authorisé le GPS pour déterminer le SSID."),
        "sentenceDocDiagnosePingDNS": MessageLookupByLibrary.simpleMessage(
            "    Si un des DNS (sauf 172.17.0.6) répond, vous êtes connecté à Internet."),
        "sentenceDocDiagnosePingGateway": MessageLookupByLibrary.simpleMessage(
            "    Cette information ne sert à rien. La passerelle ignore les pings. Cependant, si un ping est reçu, quelqu\'un a probablement pris sont IP. Mais, rien est certain."),
        ...
        "sentenceDocDiagnosePingLocal3": MessageLookupByLibrary.simpleMessage(
            " (Alertez immediatement à Minitel)\n"),
        "sentenceDocDiagnosePingLocal4": MessageLookupByLibrary.simpleMessage(
            "    2.  Vous n\'êtes pas connecté au réseau local.\n    3.  Le serveur (172.17.0.5) est éteint. (vous pouvez ping 172.17.0.1, 172.17.0.10)\n"),
        "sentenceDocLogin1": MessageLookupByLibrary.simpleMessage(
            "Choisir entre fw-cgcp.emse.fr et 172.17.0.1\n"),
        "sentenceDocLogin2": MessageLookupByLibrary.simpleMessage(
            "Si le réseau local est WiFi MINITEL, utiliser 172.17.0.1.\nSinon, vous pouvez essayer fw-cgcp.emse.fr."),
        "sentenceNotConnected": MessageLookupByLibrary.simpleMessage(
        ...
        "titleLoginPage": MessageLookupByLibrary.simpleMessage(
        ...
        "wordUsername": MessageLookupByLibrary.simpleMessage(
            "Nom d\'utilisateur"),
        "wordsAuthDuration": MessageLookupByLibrary.simpleMessage(
